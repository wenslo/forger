...
import com.github.wenslo.forger.data.jpa.repository.StringIdRepository
...
interface StringIdService<T : StringIdEntity, C : StringIdCondition> {
    ...
    fun findByIdIn(id: List<String>): List<T>?
}

abstract class StringIdServiceImpl<T : StringIdEntity, C : StringIdCondition> :
    StringIdService<T, C> {

    @Autowired
    lateinit var repository: StringIdRepository<T, String>
    ...
    override fun remove(id: List<String>) {
    ...
    override fun findByIdIn(id: List<String>): List<T>? {
