...
class DeptIdEntityBasePath<T>(
    ...
    val orgId = createNumber("orgId", Long::class.java)
    val deptId = createNumber("deptId", Long::class.java)
    val deptCode = createString("deptCode")
}